...
def _loader_len(loader: DataLoader) -> int:
    """Return the number of samples in a DataLoader safely."""
    dataset = loader.dataset
    if hasattr(dataset, "__len__"):
        return len(dataset)  # type: ignore[arg-type]
    # Fallback: lower-bound estimate from batch count
...
def run_pipeline(
    ...
    # Use the raw array lengths — known at construction, no Dataset.__len__ needed
